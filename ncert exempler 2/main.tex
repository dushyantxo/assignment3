...
\begin{align}
	...
	\end{cases}	
\end{align}
Let $X_{1}​$ represent the random variable for selecting an envelope with a cash prize of Rs $100$.\\
Let $X_{2}​$ represent the random variable for selecting an envelope with a cash prize of Rs $50$.\\
Let $X_{3}$​ represent the random variable for selecting an envelope with a cash prize of Rs $10$.\\
Then  
\begin{align}
