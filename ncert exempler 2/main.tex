...
\multirow{}{}{X} &0 & cash prize of Rs 100\\
&1 &cash prize of Rs 50\\
&2 &cash prize of Rs 10\\ \hline
\multirow{}{}{Y} &0 &Envelope with cash prize\\
&1 & no cash prize\\
\hline
\end{tabular}
...
\begin{align} 
\pr{X=0 | Y=0} &= \frac{1}{100}\\
\pr{X=1|Y=0} &= \frac{1}{10}\\
\pr{X=2|Y=0} &= \frac{2}{10}\\
\end{align}
Probablity of envelope with no cash prize
\begin{align}
\begin{split}
               p\brak{Y=1} &= 1-\brak{p\brak{X=0 | Y=0} \\ &\quad+ p\brak{X=1|Y=0} + p\brak{X=2|Y=0}}\\
               &=0.69
               \end{split}
\end{align}
\end{document}
